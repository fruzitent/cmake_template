...
# target_link_libraries(main_cuda PRIVATE project_options project_warnings) target_link_cuda(main_cuda)
#
macro(myproject_target_link_cuda target)
  ...
  # We need to explicitly state that we need all CUDA files in the ${target} library to be built with -dc as the member
  # functions could be called by other libraries and executables
  set_target_properties(${target} PROPERTIES CUDA_SEPARABLE_COMPILATION ON)

  if(APPLE)
    # We need to add the path to the driver (libcuda.dylib) as an rpath, so that the static cuda runtime can find it at
    # runtime.
